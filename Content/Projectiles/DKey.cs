...
{
    public class DKey : ModProjectile // 类名可以自己改
    {
        ...
        private int CurrentKeyDCount = 0;    // 实时 KeyACount
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (CurrentKeyDCount < ghostPlayer.KeyDCount)
                {
                    CurrentKeyDCount = ghostPlayer.KeyDCount;
                    OnKey = true;
                }
            }
            if (!initialized)
